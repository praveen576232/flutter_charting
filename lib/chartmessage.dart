...
import 'package:thumbnails/thumbnails.dart';
 ...
 // Chartmsg(this.userdata, [this.uplodefile, this.type,this.id]);
...
//      // home: HomeChart(phno, name, photo, uplodefile, userdata, type,id),
//     );
//   }
// }

class Chartmsg extends StatefulWidget {
////  String photo;
// String phno;
//String name;
 // String userdata = "";
...
class _HomeChartState extends State<Chartmsg>
...
String name;
  ...
  void initState() {
    super.initState();
  list =widget.userdata.split(",");
    phno = list[1];
    name = list[2];
    photo = list[3];
    createdir();
    helper = Databasehelper("p${phno.substring(1)}");
    
    getdata();
    audioPlayer = AudioPlayer();

    audioPlayerState = AudioPlayerState.STOPPED;
    loadmessage = Loadmessage("p${phno.substring(1)}");
        ...
        if (widget.uplodefile?.length != 0) {
          for (int i = 0; i < widget.uplodefile?.length; i++) {
            final chartuploder = ChartUploder(
              false,
                phno, myphone, widget.uplodefile[i], widget.type);
  ...
  addonline(Map map)
  {
   once=true;
      Firestore.instance
            .collection("Allusers")
            .document(myphone)
            .collection(myphone).document(widget.id).updateData(map);
  }
  getinputmsg() {
  ...
  getdata() async {
    alldata = await helper.getallresult("p${phno.substring(1)}");
  }
  ...
  checkmessages(String userphone)async {
    ...
    if (!hold) {
     if (inputmsg?.length != 0) {
      ...
      await helper.insertion(message, "p${userphone.substring(1)}").then((data) {
            if (data != 0) {
  ...
  Future downlode(String url, String path, int index,
    ...
    try {
      ...
      await helper.updatedata(
          "${phno.substring(1)}", message, index + 1);
...
//int.parse(mydate[2]),int.parse(mydate[1]),int.parse(mydate[0])   int.parse(text_date[2]),int.parse(text_date[1]),int.parse(text_date[0])
      ...
      return today1?"active on today at ${lastonline.split(',')[0]}":yesterday?"active on yesterday at ${lastonline.split(',')[0]}":"active on  ${lastonline.split(',')[1]} at ${lastonline.split(',')[0]}";
}
                                                        ...
                                                        child: InkWell(
                                                            ...
                                                            text: TextSpan(
                                                                text:" ${ snapshot
                                                                    ...
                                                                    index]['msg']}",
                                                                style: TextStyle(
                                                                    color:messagetypecheck(snapshot.data[index]['msg']) ?Colors.blue:  Colors.black
                                                          ...
                                                          onTap: (){
                                                            ...
                                                            print("click  ${messagetypecheck(snapshot.data[index]['msg'])}");
                                                            messagetypecheck(snapshot.data[index]['msg'])?OpenFile.open(snapshot.data[index]['msg'].toString()):Offstage();
                                                          },
                                                          onLongPress: (){
                                                             messagetypecheck(snapshot.data[index]['msg'])?Clipboard.setData(ClipboardData(text:snapshot.data[index]['msg'])).whenComplete((){
                                                               Fluttertoast.showToast(msg: "Link copied",gravity: ToastGravity.CENTER,toastLength: Toast.LENGTH_LONG);
                                                             }):Offstage();
                                                          },
                                                        )
                                                        )))
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Stack(
                                                                  children: <
                                                                    ...
                                                                    !pdfdownloder &&
                                                                            snapshot.data[index]['pdfpath'].toString().contains("https",
                                                                                0)
                                                                        ? Align(
                                                                            child: IconButton(
                                                                                icon: Icon(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            alignment: Alignment.centerLeft),
                                                                        !audiodownloder &&
                                                                                snapshot.data[index]['audiopath'].toString().contains("https", 0)
                                                                            ? Align(
                                                                                child: IconButton(
                                                                                    icon: Icon(
                                                                                      Icons.file_download,
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          child: GestureDetector(
                            ...
                            onLongPressStart:
                                (LongPressStartDetails detailes) async {
...
stopanimation();
                  ...
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => Vediofile(
                          phno.substring(0), "Chart", widget.userdata)));
                } else if (name == "Document") {
                     stopanimation();
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          Fdf_list(phno.substring(0),false, widget.userdata)));
                } else if (name == "Audio") {
                     stopanimation();
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          Music(false,phno.substring(0), widget.userdata)));
                } else if (name == "Contact") {
                     stopanimation();
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => List_Contact(
                         false, phno.substring(0), widget.userdata)));
  ...
  savedata(String data, String type) async {
    ...
    var result =
        await helper.insertion(message, "p${phno.substring(1)}");
    print(result);
    setState(() {
      getdata();
    });
